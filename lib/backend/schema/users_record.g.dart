    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'phone_number':
          ...
          break;
        case 'user_rank':
          result.userRank = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'location':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _userRank;
  String? get userRank => _$this._userRank;
  set userRank(String? userRank) => _$this._userRank = userRank;
