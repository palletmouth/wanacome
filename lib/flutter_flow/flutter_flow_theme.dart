...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryColor = const Color(0xFF4E376B);
  late Color tertiaryColor = const Color(0xFFFEF0ED);
  late Color alternate = const Color(0xFF3D2072);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFFF37C51);

  late Color primaryBtnText = Color(0xFFFFFFFF);
  late Color lineColor = Color(0xFFE0E3E7);
  late Color buttonBackground = Color(0xFFF78B64);
  late Color selected = Color(0xFF3D2072);
  late Color unselected = Color(0xFF4E376B);
  late Color bigRoundButton = Color(0xFFFF3B70);
