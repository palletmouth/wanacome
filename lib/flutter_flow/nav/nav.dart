...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(WanacomeFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'RegisterUser',
              path: 'registerUser',
              builder: (context, params) => RegisterUserWidget(),
            ),
            FFRoute(
              name: 'HomePage',
              path: 'homePage',
            ...
            FFRoute(
              name: 'rs',
              path: 'rs',
              builder: (context, params) => RsWidget(
                vp: params.getParam('vp', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'Seeyouthere',
              path: 'seeyouthere',
              builder: (context, params) => SeeyouthereWidget(
                attending: params.getParam('attending', ParamType.bool),
            ...
            FFRoute(
              ...
              builder: (context, params) => EventDetailsWidget(
                selectedEventID:
                    params.getParam('selectedEventID', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'CreateEvent',
